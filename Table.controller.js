sap.ui.define([
	...
	'sap/m/ObjectNumber',
	'sap/m/MessageToast'
], function (deepExtend, Formatter, Controller, JSONModel, ColumnListItem, Input, ObjectIdentifier, ObjectNumber, MessageToast) {
	"use strict";
	...
	var TableController = Controller.extend("sap.m.sample.TableEditable.Table", {
			...
			this.oEditableTemplate = new ColumnListItem({
				cells: [
					new ObjectIdentifier({
						...
						number: "{ path: 'Total', formatter: 'sap.m.sample.TableEditable.Formatter.numberUnit' }"
					})
				]
			});
		},
		...
		onOrder: function () {
			MessageToast.show("Time submitted");
		},
